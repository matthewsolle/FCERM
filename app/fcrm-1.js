...
router.get('/search-results_spec_pub-default', function(req, res) {
    res.render(folder + '/search-results_spec_pub-default', { results: filterReports(req.query.name, req.query.assets,req.query.datatype,req.query.environmental,req.query.flooding,req.query.policy,req.query.sources,req.query.status), url: req.url  })
})
...
function filterReports(searchText,assets,datatype,environmental,flooding,policy,sources,status) {
